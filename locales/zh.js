export default {
  ...
  detail: {
    ...
    contract: {
      ...
      noPublicReadFunctions: '抱歉，未找到该合约的公共读取函数。',
      noPublicWriteFunctions: '抱歉，未找到该合约的公共写入函数。',
      abiImplementationAt: '实现合约的 ABI 位于',
      readContractInformation: '读取合约信息',
      writeContractInformation: '写入合约信息',
      inquire: '读',
      toWrite: '写',
  ...
  contract: {
    ...
    verify: {
      ...
      uploadMetadataFileError: '无效的文件格式',
      onlyAllowOneMetadataFile: 'metadata.json 文件只能上传一个',
