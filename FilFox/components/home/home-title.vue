<template>
    <div class="flex flex-row h-12 items-center ml-5">
        ...
        <img v-if="type == 'minerRanks'" src="~/assets/img/home/miner-ranks.svg" alt="icon" class="w-5"/>
        <img v-if="type == 'recentTipsets'" src="~/assets/img/home/blocks.svg" alt="icon" class="w-5" />
        <img v-if="type == 'richManRanks'" src="~/assets/img/home/rich.svg" alt="icon" class="w-5"/>
