<template>
  <div class="bg-footer px-4 xl:px-0">
    <div class="w-full">
      <div class="flex container mx-auto my-6 items-center">
      ...
      <div class="container flex flex-col pb-4 lg:flex-row mx-auto justify-between">
        <div class="text-xs text-footerText">
          {{ $t('footer.intro') }}
        </div>
    ...
    <footer class="text-xs text-gray-300 text-opacity-25 container mx-auto border-t border-gray-300 border-opacity-25 py-3 px-6 text-center">
