<template>
  <div class="mb-2 bg-white">
    <div>
      ...
      <div class="justify-between flex flex-row">
        <div class="flex flex-grow h-10 ml-4 items-center relative">
          <el-tabs v-model="type" class="w-full mr-4">
          ...
          <el-dropdown
            ...
            trigger="click"
            hide-on-click
            class="border border-background px-2 rounded-sm mr-4 absolute right-0 bottom-0 mb-4"
    ...
    <div v-loading="loading">
      <div v-if="type == 0" class="flex flex-grow flex-row bg-mobileHeader text-xs px-4">
        <div class="w-1/6">
      ...
      <div v-if="type == 1" class="flex flex-grow flex-row bg-mobileHeader text-xs px-4">
        <div class="w-1/6">
          {{ $t('home.minerRanks.tableHeadersByPower.rank') }}
        </div>
        <div class="w-1/3">
      ...
      <div v-if="type == 2" class="flex flex-grow flex-row bg-mobileHeader text-xs px-4">
        <div class="w-1/6">
          {{ $t('home.minerRanks.tableHeadersByPower.rank') }}
        </div>
        <div class="w-1/3">
