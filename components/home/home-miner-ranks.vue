        ...
        <div class="flex h-12 ml-4 items-center">
          <el-row>
            <AttributeInjector size="mini" round class="focus:outline-none outline-none">
              <el-button v-bind="type === 0 ? {type: 'primary', plain: true, class: ['pointer-events-none']} : {}" @click="e => didRankTypeSwitched(e, 0)">
                {{ $t('home.minerRanks.filters.qualityAdjPower') }}
              </el-button>
              <el-button v-bind="type === 1 ? {type: 'primary', plain: true, class: ['pointer-events-none']} : {}" @click="e => didRankTypeSwitched(e, 1)">
                {{ $t('home.minerRanks.filters.blocks') }}
              </el-button>
              <el-button v-bind="type === 2 ? {type: 'primary', plain: true, class: ['pointer-events-none']} : {}" @click="e => didRankTypeSwitched(e, 2)">
