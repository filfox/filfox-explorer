<template>
  <div class="my-4 px-4 lg:px-1">
    <div v-if="token.address" class="flex flex-wrap items-center">
      <TokenIcon class="lg:w-6 lg:h-6 mr-1.5" :token-id="token.address" :token-type="token.type" />
