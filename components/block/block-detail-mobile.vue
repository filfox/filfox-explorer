<template>
  <div class="bg-white pb-2">
    ...
    <div v-loading="loading" class="flex flex-col flex-grow mt-4">
...
<style lang="postcss" scoped>
  .block-item {
    @apply flex flex-row justify-between items-center text-xs mx-4 my-1;
  }
  .message-item {
    @apply flex flex-row items-center justify-between mx-3 mt-1;
  }
</style>
