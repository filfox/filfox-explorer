<template>
  <div class="flex flex-grow flex-col bg-white">
    <div class="flex flex-col">
      ...
      <div class="justify-between flex flex-row">
        <div class="flex flex-grow h-10 ml-4 items-center relative">
          <el-tabs v-model="type" class="w-full mr-4" @tab-click="didRankTypeSwitched">
          ...
          <el-dropdown v-if="type != '0'" trigger="click" :hide-on-click="true" class="border border-background px-2 rounded-sm mr-4 absolute right-0 bottom-0 mb-4" @command="didDurationSwitched">
    ...
    <div v-if="loading" v-loading="loading" class="bg-white h-16">
    </div>
